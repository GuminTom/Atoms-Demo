...
async def query_agent_sessionss(
    ...
    """Query agent_sessionss with filtering, sorting, and pagination (user can only see their own records)"""
...
async def get_agent_sessions(
    ...
    """Get a single agent_sessions by ID (user can only see their own records)"""
...
async def update_agent_sessionss_batch(
    ...
    """Update multiple agent_sessionss in a single request (requires ownership)"""
...
async def update_agent_sessions(
    ...
    """Update an existing agent_sessions (requires ownership)"""
...
async def delete_agent_sessionss_batch(
    ...
    """Delete multiple agent_sessionss by their IDs (requires ownership)"""
...
async def delete_agent_sessions(
    ...
    """Delete a single agent_sessions by ID (requires ownership)"""
